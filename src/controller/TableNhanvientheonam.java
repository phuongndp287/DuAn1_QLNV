...
public class TableNhanvientheonam extends AbstractTableModel {
	private ArrayList<Nhanvien> listnhanvien = new ArrayList<>();
	private Nhanvien nhanvien;
	private String[] columnsnhanvien = { "STT","Năm tuyển dụng", "Số lượng nhân viên" };
	private NhanvienDAO nhanviendao = new NhanvienDAO();
	
	public NhanvienDAO getnhanvienDAO() {
		return nhanviendao;
	}
	public TableNhanvientheonam(int mapb) {

		listnhanvien = nhanviendao.getAllNhanvienTheophongban(mapb);
		
	}

	public TableNhanvientheonam() {
